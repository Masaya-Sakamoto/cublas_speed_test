...
# compile utils
g++ -O3 -Iinclude -c src/utils.cpp -o build/modules/utils.o

# compile CXX files
g++ -O3 -Iinclude -c src/cblas_col_speed_test.cpp -o build/modules/cblas_col_speed_test.o -std=c++20
g++ -O3 -Iinclude -c src/cblas_row_speed_test.cpp -o build/modules/cblas_row_speed_test.o -std=c++20
